...
#if GLM_COMPILER & GLM_COMPILER_CLANG
#	define GLM_HAS_RANW_FOR __has_feature(cxx_range_for)
#elif GLM_LANG & GLM_LANG_CXX11_FLAG
#	define GLM_HAS_RANW_FOR 1
#else
#	define GLM_HAS_RANW_FOR ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (\
		((GLM_COMPILER & GLM_COMPILER_INTEL)) || \
		((GLM_COMPILER & GLM_COMPILER_VC)) || \
		((GLM_COMPILER & GLM_COMPILER_CUDA)) || \
		((GLM_COMPILER & GLM_COMPILER_HIP))))
...
#if GLM_MESSAGES == GLM_ENABLE && !defined(GLM_MESSAW_DISPLAYED)
#	define GLM_MESSAW_DISPLAYED
